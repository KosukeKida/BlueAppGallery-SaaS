            ...
            <Card>
              ...
              <CardContent>
                {mounted && (data?.appRanking.length ?? 0) > 0 ? (
                  <ResponsiveContainer width="100%" height={Math.max(200, data!.appRanking.length * 38)} className="[&_.recharts-surface]:outline-none [&_.recharts-wrapper]:outline-none [&_*:focus]:outline-none">
                    <BarChart
